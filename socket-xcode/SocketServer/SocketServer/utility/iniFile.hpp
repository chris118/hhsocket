...
public:
    ...
    std::string readstring(std::string pSect, std::string pKey, std::string szDefault, unsigned int &nSize)
    {
    ...
    int readinteger(std::string pSect, std::string pKey, int iValue = 0)
    {
        unsigned int nSize = 0;
        std::string pValue = readstring(pSect, pKey, "", nSize).c_str();
        if ("" == pValue)
        {
            return iValue;
        }
    ...
    double readdouble(std::string pSect, std::string pKey, double dValue = 0)
    {
        unsigned int nSize = 0;
        std::string pValue = readstring(pSect, pKey, "", nSize).c_str();
        if ("" == pValue)
    ...
    {
        unsigned int nSize = 0;
        const char *pValue = readstring(pSect, pKey, NULL, nSize).c_str();
        if (NULL == pValue)
        {
            return bValue;
        }
